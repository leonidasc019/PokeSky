...
local damageMultiplier = damageMultiplierMoves.areawaves / #areas

-- Offset para ajustar a posição do efeito
local offsetX = 2  -- Ajuste para mover o poder para a direita
local offsetY = 2  -- Ajuste para mover o poder para cima, arredondando para inteiro
...
local function spellCallback(uid, position, damage, count)
    ...
    doAreaCombatHealth(uid, combat, position, 0, -damage, -damage, 1540) --effeito
